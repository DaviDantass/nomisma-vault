...
public class AssetController {
  ...
  @GetMapping("/{id}")
  public ResponseEntity<AssetResponse> findAssetById(@PathVariable Long id) {
    return ResponseEntity.ok(assetService.findById(id));
  }

  @GetMapping("/ticker/{ticker}")
  public ResponseEntity<AssetResponse> findAssetByTicker(@PathVariable String ticker) {
  ...
  public ResponseEntity<AssetResponse> updateAsset(
    ...
    return ResponseEntity.ok(assetService.update(id, request.categoryId(), request));
  }
