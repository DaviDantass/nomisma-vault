...
public class TransactionController {
  ...
  @GetMapping
  public ResponseEntity<PageResponse<TransactionResponse>> findAllTransactionsByPortfolio(
      @PathVariable Long portfolioId, Pageable pageable) {

    return ResponseEntity.ok(
        PageResponse.from(transactionService.findAllByPortfolio(portfolioId, pageable)));
  }

  @GetMapping("/{transactionId}")
  public ResponseEntity<TransactionResponse> findTransactionById(
      @PathVariable Long portfolioId, @PathVariable Long transactionId) {

    return ResponseEntity.ok(transactionService.findById(portfolioId, transactionId));
  }

  @GetMapping("/period")
  public ResponseEntity<PageResponse<TransactionResponse>> findTransactionsByPeriod(
  ...
  public ResponseEntity<TransactionResponse> createTransaction(
      @PathVariable Long portfolioId, @Valid @RequestBody TransactionRequest request) {
