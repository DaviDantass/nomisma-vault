...
public class PriceHistoryController {
  ...
  public ResponseEntity<List<PriceHistoryResponse>> findByAssetIdAndDateRange(
    ...
    return ResponseEntity.ok(
        priceHistoryService.findByAssetIdAndDateRange(assetId, startDate, endDate));
  }
  ...
  @PostMapping
  public ResponseEntity<PriceHistoryResponse> create(
  ...
  public ResponseEntity<PriceHistoryResponse> update(
      @PathVariable Long id, @Valid @RequestBody PriceHistoryRequest request) {
