...
public class Investment {
  ...
  public void updatePosition(
      TransactionType type, BigDecimal transactionQuantity, BigDecimal transactionPrice) {
    if (type == TransactionType.BUY) {
      ...
      this.averagePrice = currentTotal.add(newTotal).divide(newQuantity, 2, RoundingMode.HALF_UP);
