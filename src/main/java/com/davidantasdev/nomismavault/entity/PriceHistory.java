...
/**
 * Snapshot diário da cotação observada pelo NomismaVault.
 *
 * <p>Não representa uma série histórica oficial completa do mercado. A restrição única por ativo e
 * data preserva uma observação por dia.
 */
public class PriceHistory {
  ...
  public String toString() {
    return "PriceHistory{" + "id=" + id + ", price=" + price + ", date=" + date + '}';
  }
