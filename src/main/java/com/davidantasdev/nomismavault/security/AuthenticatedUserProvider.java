...
public class AuthenticatedUserProvider {
  ...
  /** Garante que uma consulta por e-mail não exponha o perfil de outro usuário. */
  public void validateEmailOwnership(String resourceEmail) {
    if (!getCurrentUser().getEmail().equalsIgnoreCase(resourceEmail)) {
      throw new AccessDeniedException(
          "Access denied: You don't have permission to access this resource");
    }
  }
